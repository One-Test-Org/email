function setCookie(e, t, n, r, i) {
    ...
    var s = "expires=" + o.toUTCString()
      , a = r ? "SameSite=" + r : ""
      , c = i ? "domain=" + i : "";
    document.cookie = [`${e}=${t}`, s, a, c, "Secure", "path=/"].filter(Boolean).join(";")
}
...
function hcaptchaCallback() {
    document.querySelector("[data-form='support']").submit()
}
...
!function(e, t) {
    ...
    function f(e) {
        return {
            ...
            controllerConstructor: m(e.controllerConstructor)
        }
    }
    function m(e) {
        var t = R(e);
    ...
    var T, C = function() {
        ...
        e.prototype.handleEvent = function(e) {
            for (var n = t(e), r = 0, i = this.bindings; r < i.length; r++) {
                var o = i[r];
        ...
        e.prototype.fetchEventListener = function(e, t) {
            var n = this.fetchEventListenerMapForEventTarget(e)
              , r = n.get(t);
            return r || (r = this.createEventListener(e, t),
            n.set(t, r)),
            r
        }
        ,
        ...
        ,
        e
    }(), S = /^((.+?)(@(window|document))?->)?(.+?)(#(.+))?$/, _ = function() {
        function e(e, t, n) {
            this.element = e,
            this.index = t,
            this.eventTarget = n.eventTarget || e,
            this.eventName = n.eventName || o(e) || s("missing event name"),
            this.identifier = n.identifier || s("missing identifier"),
            this.methodName = n.methodName || s("missing method name")
        }
        ...
        e.prototype.invokeWithEvent = function(e) {
            try {
                ...
                this.context.handleError(s, 'invoking action "' + this.action + '"', n)
            }
        }
        ,
        ...
        function e(e, t, n) {
            ...
            this.delegate = n,
            this.elementObserver = new x(e,this)
        }
        ...
        ,
        e
    }(), M = undefined && undefined.__extends || (T = Object.setPrototypeOf || {
        __proto__: []
    ...
    function() {
        function e(e, t, n) {
            this.attributeObserver = new j(e,t,this),
            this.delegate = n,
            this.tokensByElement = new N
        }
        ...
        e.prototype.readTokensForElement = function(e) {
            ...
            return d(e.getAttribute(t) || "", e, t)
        }
        ,
        e
    }()), F = function() {
        function e(e, t, n) {
            this.tokenListObserver = new I(e,t,this),
            this.delegate = n,
        ...
        return e.prototype.start = function() {
            this.valueListObserver || (this.valueListObserver = new F(this.element,this.actionAttribute,this),
        ...
        function e(e, t) {
            ...
            this.bindingObserver = new D(this,this.dispatcher);
            try {
        ...
        return e.prototype.connect = function() {
            ...
            try {
                ...
                this.handleError(s, "connecting controller")
            }
        }
        ,
        e.prototype.disconnect = function() {
            try {
                ...
                this.handleError(s, "disconnecting controller")
            }
        ...
        ,
        e
    }(), W = undefined && undefined.__extends || function() {
        ...
        e.prototype.get = function(e) {
            return e = this.getFormattedKey(e),
            this.element.getAttribute(e)
        }
        ,
        ...
        e.prototype["delete"] = function(e) {
            return !!this.has(e) && (e = this.getFormattedKey(e),
            this.element.removeAttribute(e),
            !0)
        }
        ,
        e.prototype.getFormattedKey = function(e) {
            return "data-" + this.identifier + "-" + g(e)
        }
        ,
        e
    }(), z = function() {
        ...
        e.prototype.parseValueForToken = function(e) {
            var t = e.element
              ...
              , i = r.get(n);
            return i || (i = new K(this.schema,n,t),
            r.set(n, i)),
            i
        }
        ,
        ...
        e.prototype.loadDefinition = function(e) {
            ...
            var t = new V(this.application,e);
    ...
    }, $ = undefined && undefined.__awaiter || function(e, t, n, r) {
    ...
    , Q = undefined && undefined.__generator || function(e, t) {
        function n(e) {
            return function(t) {
                return r([e, t])
            }
            ...
            for (; c; )
                try {
                    ...
                    case 7:
                        ...
                        continue;
                    default:
                        if (!(s = (s = c.trys).length > 0 && s[s.length - 1]) && (6 === n[0] || 2 === n[0])) {
                            c = 0;
                            continue
                        }
...
class EngagedSessionController extends Stimulus.Controller {
    connect() {
        this.loadEngagedSessionTracker()
    }
    loadEngagedSessionTracker() {
        this.timer = setInterval(()=>this.checkEngagedSessionStatus(), 1e3)
    }
    checkEngagedSessionStatus() {
        if (this.sessionHasEngaged())
            return clearInterval(this.timer);
        this.sessionTimeIsOverThreshold() && (this.trackEngagedSessionWithPlausible(),
        this.markSessionAsEngaged())
    }
    setSessionParam(e, t) {
        let n = this.getSessionParams()
          , r = 30 / 1440;
        n[e] = t,
        setCookie("session_details", JSON.stringify(n), r)
    }
    getSessionParams(e) {
        const t = getCookie("session_details")
          , n = t ? JSON.parse(t) : {};
        return e ? n[e] : n
    }
    trackEngagedSessionWithPlausible() {
        window.plausible && plausible("EngagedSession")
    }
    sessionHasEngaged() {
        return Boolean(this.getSessionParams("already_engaged"))
    }
    markSessionAsEngaged() {
        this.setSessionParam("already_engaged", !0)
    }
    sessionTimeIsOverThreshold() {
        const e = 60;
        return new Date - this.getEngagedSessionStartTime() >= 1e3 * e
    }
    getEngagedSessionStartTime() {
        const e = this.getSessionParams("entry_time");
        if (e)
            return new Date(e);
        const t = new Date;
        return this.setSessionParam("entry_time", t),
        t
    }
}
class NewsletterController extends Stimulus.Controller {
    connect() {
        this.mc_form = document.querySelector("#mc-embedded-subscribe-form"),
        this.mc_button = this.mc_form.querySelector("#mc-embedded-subscribe"),
        this.mc_email = this.mc_form.querySelector("#mce-EMAIL"),
        this.mc_tags = [],
        this.handleInteractionNotices(),
        this.handleFormSubmission(),
        this.handleAutomaticOptIn()
    }
    handleInteractionNotices() {
        ["focus", "input", "click"].forEach(e=>{
            this.mc_email.addEventListener(e, ()=>{
    ...
    handleFormSubmission() {
        this.mc_form.addEventListener("submit", e=>{
            e.preventDefault(),
            this.prepareAndSendForm()
        }
        )
    }
    handleAutomaticOptIn() {
        let e = 22945
          ...
          , n = t.searchParams.get("email")
          , r = "true" === t.searchParams.get("confirm-opt-in");
        n && (this.mc_email.value = n,
        r && (this.mc_tags.push(e),
        this.prepareAndSendForm()))
    }
    prepareAndSendForm() {
        this.mc_formdata = new FormData(this.mc_form),
        this.emailIsInvalid() ? this.showErrorNotice() : (this.appendTags(),
        this.mc_button.disabled = !0,
        this.sendFormToMailchimp())
    }
    sendFormToMailchimp() {
        fetch(this.mc_form.action, {
            body: this.mc_formdata,
            method: this.mc_form.method,
            mode: "no-cors"
        }).then(()=>{
            this.mc_form.reset(),
            location.assign("/newsletter/thanks")
        }
        )
    }
    appendTags() {
        this.mc_formdata.append("tags", this.mc_tags.join(","))
    }
    emailIsInvalid() {
        return !this.emailIsValid()
    }
    emailIsValid() {
        return !!this.mc_email.value && /^[\w\.\+]+@([\w-]+\.)+[\w-]{2,}$/.test(this.mc_email.value)
    }
    showErrorNotice() {
        this.mc_form.classList.add("newsletter-form--error")
    }
    hideErrorNotice() {
        this.mc_form.classList.remove("newsletter-form--error")
    }
}
class SignupController extends Stimulus.Controller {
    track() {
    ...
    trackConversionWithGoogle() {
        window.gtag && gtag("event", "conversion", {
            send_to: "AW-882027520/tONxCJ_Zi44DEIDYyqQD"
        })
    }
    trackLoginWithGoogle() {
        window.gtag && gtag("event", "conversion", {
            send_to: "AW-882027520/isWhCK_PxfUDEIDYyqQD",
            aw_remarketing_only: !0
        })
    }
    trackConversionWithReddit() {
        window.rdt && rdt("track", "SignUp")
    }
    trackConversionWithLinkedIn() {
        window.lintrk && window.lintrk("track", {
            conversion_id: 8533540
        })
    }
    trackConversionWithPlausible() {
        window.plausible && plausible("TrialButtonClick")
    }
    trackConversionWithChoozle() {
        if (window.Bootstrapper) {
            let e = document.createElement("iframe");
            e.src = "//insight.adsrvr.org/tags/39xjf87/z9ha8px/iframe",
    ...
    trackConversionWithMicrosoft() {
        window.uetq && (window.uetq = window.uetq || [],
    ...
    get urlWithTrackedParams() {
        const e = new URL(this.element.href);
        for (const [t,n] of Object.entries(this.trackedParams))
            e.searchParams.set(t, n);
        return e
    }
    get trackingPermissionGranted() {
        return "granted" === getCookie("tracking_permission")
    }
    get trackedParams() {
        const e = getCookie("tracking_params");
        return e ? JSON.parse(e) : {}
    }
}
class SignupIframeController extends Stimulus.Controller {
    connect() {
        this.appendTrackedParams()
    }
    appendTrackedParams() {
    ...
    get urlWithTrackedParams() {
        const e = new URL(this.element.dataset.sourceValue);
        for (const [t,n] of Object.entries(this.trackedParams))
            e.searchParams.set(t, n);
        return e.searchParams.set("iframe_host", window.location.href),
        e
    }
    get trackedParams() {
        const e = getCookie("tracking_params");
...
class TrackingController extends Stimulus.Controller {
    static get targets() {
        return ["permissionDialog"]
    }
    connect() {
        this.rememberTrackedParams(),
        this.hasTrackedParams && (this.skipPermissionsCheck ? this.permissionGranted() : this.permissionRequired())
    }
    grant(e) {
        e.preventDefault(),
    ...
    rememberTrackedParams() {
        Object.keys(this.trackedParamsFromRequest).length && setCookie("tracking_params", JSON.stringify(this.trackedParams), 30, null, includingSubdomainsScope())
    }
    forgetTrackedParams() {
    ...
    get trackedParams() {
        return {
            ...this.trackedParamsFromCookie,
            ...this.trackedParamsFromRequest
        }
    }
    ...
    get trackedParamsFromRequest() {
        const e = {};
        for (const [t,n] of this.params)
            (t.startsWith("utm_") || "network" === t) && (e[t] = n);
        return e
    }
    get params() {
    ...
    set permission(e) {
        setCookie("tracking_permission", e, 30)
    }
    loadAdTracker() {
        "google" === this.trackedParams.network ? this.loadGoogleTagManager() : "choozle" === this.trackedParams.network ? this.loadChoozleTracker() : "microsoft" === this.trackedParams.network ? this.loadMicrosoftTracker() : "linkedin" === this.trackedParams.network ? this.loadLinkedInTracker() : "reddit" === this.trackedParams.network ? this.loadRedditTracker() : "zencastr" === this.trackedParams.network && this.loadZencastrTracker()
    }
    loadChoozleTracker() {
        if (this.choozleTrackerLoaded)
            return;
        const e = document.createElement("script");
        e.async = !0,
        e.src = "//nexus.ensighten.com/choozle/16916/Bootstrap.js",
        document.head.appendChild(e),
        this.choozleTrackerLoaded = !0
    }
    loadGoogleTagManager() {
        if (this.googleTagManagerLoaded)
            return;
        const e = "AW-882027520"
        ...
        this.googleTagManagerLoaded = !0
    }
    loadLinkedInTracker() {
        if (this.linkedInTrackerLoaded)
            return;
...
function() {
    ...
    e = {
        ...
        skybox: {
            name: "the 37signals Suite"
        }
    },
    t = "https://37signals.typeform.com/to/M4eDXjbW#id=:accountId:",
    r = function(e) {
        return document.querySelector("[data-behavior='cancel_product']").textContent = e
    }
    ,
    i = function(e) {
        var n;
        return (n = document.querySelector("[data-behavior='cancel_survey']")).querySelector("a").href = t.replace(/:accountId:/, e),
        n.style.display = ""
    }
    ,
    n = function(e) {
...
function() {
    var e, t, n;
    "/" === window.location.pathname && null !== (t = getCookie("_bc3_last_access")) && (sessionStorage.getItem("hasBeenWelcomed") || (sessionStorage.setItem("hasBeenWelcomed", "true"),
    e = new Date,
    n = new Date(t),
    Math.abs(e - n) / 36e5,
...
.call(this);
class marketingRedirect {
    static ready() {
        function e(e) {
            let t;
            switch (e) {
            case "hell":
                t = "https://sendyourbosstohell.com/";
                break;
            default:
                t = "/"
            }
...
(function() {
    window.addEventListener("DOMContentLoaded", function() {
        ...
        if (document.querySelectorAll("[data-form='support']").length > 0) {
            if (null !== (n = getCookie("help")))
                for (r in o = JSON.parse(n))
                    for (c = o[r],
                    t = 0,
                    i = (e = document.querySelectorAll("[data-support*='" + r + "']")).length; t < i; t++)
                        e[t].value = c;
            if (s = document.querySelectorAll("[data-support='source']"),
            a = getParameterByName("source"))
                return s[0].value = a
        }
    })
}
...
function() {
    window.addEventListener("DOMContentLoaded", function() {
        var e, t, n, r, i, o, s;
        if (t = document.querySelector("form#new_ticket_form")) {
            for (validate.validators.maxFileSize = function() {
                var e, t, n, r;
                for (e = 0,
                t = 0,
                n = (r = document.querySelector("#ticket_file").files).length; t < n; t++)
                    e += r[t].size / 1024 / 1024;
                return e > 20 ? "Attachments must be 20MB or less" : null
            }
            ,
            e = {
                "ticket[issue_type]": {
                ...
                "ticket[details]": {
                    presence: {
                        message: "Tell us what your question, comment, or issue is"
                    }
                },
                "ticket[email_address]": {
                    presence: {
                        message: "We need a working email address to reply back to you"
                    },
                    email: {
                        message: "We need a working email address to reply back to you"
                    }
            ...
            s = [],
            n = 0,
            o = (i = document.querySelectorAll("input, textarea, select")).length; n < o; n++)
                r = i[n],
                s.push(r.addEventListener("change", function() {
                    var n;
...
function() {
    window.addEventListener("DOMContentLoaded", function() {
        ...
        /Basecamp iOS/i.test(navigator.userAgent) && !/replace-sheet/.test(navigator.userAgent) && (e.className += " ios"),
        /BC3 Android/i.test(navigator.userAgent))
            return e.className += " android"
    })
}
.call(this);
